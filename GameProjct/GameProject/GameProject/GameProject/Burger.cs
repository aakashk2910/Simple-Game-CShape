    ...
    public class Burger
    {
        ...
        public int Health
        {
            ...
            set
            {
                ...
                if (health > GameConstants.BURGER_INITIAL_HEALTH)
                {
                    health = GameConstants.BURGER_INITIAL_HEALTH;
                }
            }
        }
        ...
        public void Update(GameTime gameTime, KeyboardState keyboard)
        {
            ...
            if (health > 0)
            {
                ...
                {
                    Projectile projectile = new Projectile(ProjectileType.FrenchFries, Game1.GetProjectileSprite(ProjectileType.FrenchFries), drawRectangle.X, drawRectangle.Y, GameConstants.FRENCH_FRIES_PROJECTILE_SPEED);
