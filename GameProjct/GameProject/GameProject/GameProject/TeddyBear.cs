...
namespace GameProject
{
    ...
    public class TeddyBear
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            {
                shootSound.Play(0.3f, 0.03f, 0f);
                elapsedShotTime = 0;
                firingDelay = GetRandomFiringDelay();

                Projectile bearProjectile = new Projectile(ProjectileType.TeddyBear, Game1.GetProjectileSprite(ProjectileType.TeddyBear), drawRectangle.Center.X, drawRectangle.Center.Y + GameConstants.TEDDY_BEAR_PROJECTILE_OFFSET, GetProjectileYVelocity());
        ...
        private void BounceTopBottom()
        {
            ...
            {
                // bounce off top
                bounceSound.Play(0.5f, 0.5f, 0f); //play sound
                drawRectangle.Y = 0;
                velocity.Y *= -1;
            }
